...
there can be defined a couple of densely defined and closable realizations
...
\item[-] 
weak solutions of elliptic boundary value problems exist and are unique,
...
lead to self-adjoint realizations in Hilbert space $\Lh$;
\end{itemize}

\subparagraph{}
This enumeration is of course only a small selection of results,
but may give a good impression
how functional analysis tools help to give insight into these problems.
