...
\[
R(\linA,\zeta) \= r_{\zeta}(A) \= \int_{\R} r_{\zeta} \,dP
\]
...
\]
The mapping $\Phi_x \: \H^+ \xto \H^+$ is a Herglotz function,
that is,
$\im \zeta \geq 0$ implies $\im \Phi_x(\zeta) \geq 0$.
This can be shown by
\[
\im \Phi_x(\zeta) = \im \int_{\R} \frac{1}{\lambda-\zeta} \,d\mu_x(\lambda) = 
\int_{\R} \frac{\im \zeta}{\abs{\lambda-\zeta} ^2} \,d\mu_x(\lambda) =
\im \zeta \cdot \phi(\zeta),
\]
where 
\[
\phi(\zeta) \eqdef \int_{\R} \frac{1}{\abs{\lambda-\zeta} ^2} \,d\mu_x(\lambda)
\, \geq \, 0.
\]
