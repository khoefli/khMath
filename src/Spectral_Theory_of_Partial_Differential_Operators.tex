...
but in many cases the terms of highest order have constant
...
\subparagraph*{}
It turns out,
that very often one proves the $A$-boundedness with relative bound $<1$
of a perturbation $B$ by proving that it is $A$-bounded with $A$-bound $0$.
This is so,
