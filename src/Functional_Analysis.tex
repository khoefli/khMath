...
%------------------------------------------------------------------------------%
 ...
 4. & Linear Operators Associated with a H-Elliptic Form             \Df &128 \\
...
\]
forms a dense subspace of $B(\R)$,
and the supremum norm of a function $e \xeof S(\R)$ is given by
