...
%------------------------------------------------------------------------------%
 ...
 III. & Adjoint Spaces and Operators                           \Df &  38 \\ % 15
  IV. & Normally Solvable Operators                            \Df &  53 \\ %  6
   V. & Calculus of Vector-Valued Functions                    \Df &  27 \\ % 11
...
VIII. & Linear Operators in Hilbert Space                      \Df &  90 \\ %  7
  IX. & Spectral Theory of Self-Adjoint Operators              \Df &  98 \\ % 15
   X. & Semigroups of Bounded Linear Operators                 \Df & 113 \\ %  9
...
\centerline
{
\begin{tabular}{R{5mm}L{92mm}R{5mm}}
%------------------------------------------------------------------------------%
...
\begin{tabular}{R{5mm}L{92mm}R{5mm}}
%------------------------------------------------------------------------------%
 1. & Resolvent and Spectrum of Banach Algebra Elements              \Df & 72 \\
 2. & Gelfand Representation                                         \Df & 73 \\
 3. & Involutional Algebras and C*-Algebras                          \Df & 74 \\
 4. & The Gelfand-Naimark Theorem                                    \Df & 76 \\
 5. & Locally Compact Abelian Groups                                 \Df & 78 \\
 6. & Abstract Fourier Transformation                                \Df & 81 \\
 7. & Fourier Transformation in Euclidean Spaces                     \Df & 85 \\
%------------------------------------------------------------------------------%
\end{tabular}
}
...
\begin{tabular}{R{5mm}L{92mm}R{5mm}}
%------------------------------------------------------------------------------%
 1. & Linear Partial Differential Operators                          \Df &136 \\
 2. & Free Space and Boundary Value Problems                         \Df &139 \\
 3. & Operators of Elliptic, Parabolic and Hyperbolic Type           \Df &141 \\
 4. & Functional Analytic Methods for Differential Operators         \Df &143 \\
 5. & Realizations in the Spaces $C^{k,\gamma}(\G)$ and $L^p(\G)$    \Df &145 \\
 6. & Closeness and Closability of Differential Operators            \Df &147 \\
 7. & The Fredholm Property of Properly Elliptic Operators           \Df &149 \\
 8. & Self-Adjoint Extensions in Hilbert Space L²(G)                 \Df &152 \\
 9. & Eigenvalue Problems in Bounded Domains                         \Df &154 \\
10. & Variational Boundary Value Problems                            \Df &155 \\
11. & Linear Differential Operators in Distributional Spaces         \Df &157 \\
12. & Fourier Transform Methods                                      \Df &160 \\
%------------------------------------------------------------------------------%
\end{tabular}
}
...
%  §2. The Gelfand Representation ---
%  §3. Involutional Algebras and C*-Algebras ---
...
%------------------------------------------------------------------------------%
Recall that we denote a linear differential expression $\DO$ to be
\textit{formally self-adjoint},
if $\DO^{\dag} \eq \DO$ holds.
In case of $\DO$ has constant coefficients,
then the expression is formally self-adjoint
iff
$c_{\alpha} \in \R$ for $\abs{\alpha} $ even
and $c_{\alpha} \in i \, \R$ for $\abs{\alpha} $ odd.

\paragraph{} %- examples of self-adjoint realizations
It is our aim to enumerate a couple
...
and in this paragraph we want to apply the abstract theory
